...
//  if(location1.lat <= 90 && location1.lat >= -90 && location2.lat >= -90 && location2.lat <= 90){
//    if(location1.lng <= 180 && location1.lng >= -180 && location2.lng >= -180 && location2.lng <= 180){
      x = (location1.lat + location2.lat) / 2;
      y = (location1.lng + location2.lng) / 2;
      return {lat : x, lng : y};
}//}} 
// Patrick tested and function works
